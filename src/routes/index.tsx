...
const steps = [
  {
    ...
    body: "Roll number, department, year and skills. Team leads search this directory to find you.",
  },
  {
    n: "02",
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" variant="secondary">
                <Link to={user ? "/dashboard" : "/auth"}>
                  {user ? "Go to my portal" : "Sign in with college email"}
                </Link>
              </Button>
              <Button
                asChild
